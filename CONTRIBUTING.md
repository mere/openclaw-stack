...
- **Documentation:** Fixes and improvements to README, `core/common/` docs (e.g. GUARD_BRIDGE.md — no-bridge model; GUARD_POLICY_PROFILE.md — exec approvals), and other docs are always welcome.
